...
- **Full Stack Developer Intern**  
  *Accolade Tech Solutions* (Mar – Jun 2024)  
  ...
  - Designed **RESTful APIs** for optimal data handling and integration.  
...
<ul align="left">
  <li>**Languages:** Python, C++, JavaScript, HTML/CSS</li>
  <li>**Libraries/Frameworks:** React.js, Next.js, Flask, Node.js</li>
  <li>**Database Management:** MySQL</li>
  <li>**Web Development Tools:** AWS, Firebase, GitHub, SEO</li>
</ul>
